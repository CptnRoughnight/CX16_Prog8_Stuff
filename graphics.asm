; w65c02 assembly code for 'graphics'
; generated by prog8.codegen.cpu6502.ProgramAndVarsGen on 2024-10-20T22:04
...
; ---- block: 'p8b_main' ----
p8b_main	.proc
	p8c_SPRITE_DATA_ADDR = $2000
	p8c_SPRITE_DATA_BANK = 1
	p8c_SPRITE_PAL_OFFSET = 1
...
string_1	; ISO:"face.bin"
	.byte  $66, $61, $63, $65, $2e, $62, $69, $6e, $00
string_2	; ISO:"FACEPAL.BIN"
	.byte  $46, $41, $43, $45, $50, $41, $4c, $2e, $42, $49, $4e, $00
...
p8s_addr_mul_24_for_highres_4c	.proc
            ldy  #5
-           asl  cx16.r2
            rol  cx16.r2+1
            dey
...
p8s_addr_mul_24_for_lores_256c	.proc
            sta  P8ZP_SCRATCH_W1
            sty  P8ZP_SCRATCH_W1+1
            lda  cx16.r0
            sta  P8ZP_SCRATCH_B1
...
p8s_init	.proc
p8v_width_flag 	= 42 	; zp UBYTE
p8v_spritenum 	= 43 	; zp UBYTE
p8v_palette_offset 	= 44 	; zp UBYTE
p8v_height_flag 	= 45 	; zp UBYTE
p8v_databank 	= 46 	; zp UBYTE
p8v_dataaddr 	= 47 	; zp UWORD
p8v_colors_flag 	= 49 	; zp UBYTE
; statements
	lda  p8v_spritenum
	sta  p8b_sprites.p8s_pos.p8v_spritenum
